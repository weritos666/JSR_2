...
-include vendor/dns/s4503/BoardConfigVendor.mk
...
# TARGET_PREBUILT_KERNEL := device/dns/s4503/zImage
TARGET_KERNEL_SOURCE := kernel/dns/s4503/JSR/kernel
TARGET_KERNEL_CONFIG := d9_defconfig

# KERNEL_EXTERNAL_MODULES:
#	mkdir -p $(KERNEL_MODULES_OUT)/ath6kl
#	rm -rf $(TARGET_OUT_INTERMEDIATES)/compat-wireless
#	cp -a device/dns/s4503/compat-wireless $(TARGET_OUT_INTERMEDIATES)/
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1256277934
